          ...
          >
            ...
            <div className="relative p-3 pt-4">
              <div
                ...
                style={{ boxShadow: "inset 0 0 0 1px rgba(148, 163, 184, 0.1)" }}
              >
                <div className="w-full h-52 bg-blue-900/40 animate-pulse rounded-lg"></div>
            ...
            <div className="p-3 pt-1 pb-4 flex-grow flex flex-col justify-between">
              <div className="h-6 w-32 bg-blue-900/40 rounded mx-auto animate-pulse mb-2"></div>
              <div className="flex flex-wrap justify-center gap-2 mt-auto">
                <div className="px-2 py-1 h-6 w-20 rounded-full bg-blue-900/50 animate-pulse"></div>
              </div>
            </div>
          </div>
        </div>
